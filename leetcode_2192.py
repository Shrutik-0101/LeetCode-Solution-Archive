# Process
# DFS/BFS traversal:
# Use Depth-First Search (DFS) or Breadth-First Search (BFS) to find all ancestors of each node.

# Track ancestors:
# Maintain a list of ancestors for each node.

# Update ancestors:
# Update the ancestors list during the traversal
